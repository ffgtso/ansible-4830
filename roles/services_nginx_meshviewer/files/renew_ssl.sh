...
simp_le -v --email technik@freifunk-rhein-sieg.net -f account_key.json -f key.pem -f fullchain.pem -d map.freifunk-rhein-sieg.net:/var/w
ww/map.freifunk-rhein-sieg.net &
wait
